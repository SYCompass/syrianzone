-- Insert bmj45–bmj47 into 'best-ministers' poll at the end of current sort
...
FROM (
  VALUES
    ('bmj45', 'الستاليني', '/tierlist/images/jolani/jolani45.webp', 1),
    ('bmj46', 'الشيوعي', '/tierlist/images/jolani/jolani46.png', 2),
    ('bmj47', 'الباد بوي', '/tierlist/images/jolani/jolani47.png', 3)
