...
const subapps = ["bingo","board","compass","food","game","hotels","house","legacytierlist","party","population","sites","startpage","stats","syid","syofficial","alignment","syrian-contributors"]
